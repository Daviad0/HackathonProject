#pragma checksum "C:\Users\djree\source\repos\HackathonProject\PolarHab\PolarHab\Pages\ActivityMenu.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d4354a71f43a7047ebe7b45e95b6f2d68a6bac2a"
// <auto-generated/>
...
#nullable disable
            ...
            __builder.AddMarkupContent(205, @"<div class=""shadow"" style=""width:80%;padding:20px;border-radius:8px"">
        <span style=""font-size:30px;font-family:'Century Gothic',Tahoma;font-weight:700"">
            Optional Content
        </span>
        <br>
        <span style=""text-wrap:normal;font-family:'Century Gothic',Tahoma"">
            This isn't required to complete the lessons, but we highly reccommend it!
        </span>
    </div>
    <br>
    ");
            __builder.AddMarkupContent(206, @"<div onclick=""location.href='/ar'"" class=""shadow-sm activity"" style=""padding:10px;width:20%;text-align:center;cursor:pointer;border-radius:8px;display:inline-block;margin:10px"">
        <span style=""text-wrap:normal;font-family:'Century Gothic',Tahoma"" class=""nonhover"">
            echoAR Polar Bear <span style=""background-color:deeppink;font-size:10px;margin:5px;border-radius:4px;color:white;padding:5px;display:inline"">Optional</span>
        </span>
    </div>
");
            __builder.CloseElement();
...
#nullable restore
#line 224 "C:\Users\djree\source\repos\HackathonProject\PolarHab\PolarHab\Pages\ActivityMenu.razor"
